...
variable "container_image" {
  description = "Full URI till Docker-imagen i ECR (t.ex. 123456789012.dkr.ecr.eu-north-1.amazonaws.com/labb5-app:1.1.0)"
  type        = string
}

variable "container_port" {
  description = "Porten som containern lyssnar på"
  type        = number
  default     = 5000
}

variable "app_version" {
  description = "Applikationsversion (sätts som miljövariabel i containern)"
  type        = string
  default     = "1.0.0"
}